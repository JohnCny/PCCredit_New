...
public class TCustomerBasic extends GenericEntity<Integer> {
    ...
    /**
     * 客户状态(0正常，1 高风险用户  2 黑名单用户  3 高风险转黑名单审核  4 黑名单转出  5 禁用客户  6 客户移交中 7 风险名单转出审核中)
     */
    @Column(name = "CUSTOMER_STATUS")
    @ApiModelProperty(value = "(0正常，1 高风险用户  2 黑名单用户  3 高风险转黑名单审核  4 黑名单转出  5 禁用客户  7 风险名单转出审核中)", required = true)
