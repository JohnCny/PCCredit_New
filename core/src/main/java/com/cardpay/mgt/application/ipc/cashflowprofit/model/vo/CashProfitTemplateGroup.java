...
public class CashProfitTemplateGroup {
     ...
     * children
     */
    private List<CashProfitTemplateGroup> groups;
    ...
    public List<CashProfitTemplateGroup> getGroups() {
        return groups;
    }

    public void setGroups(List<CashProfitTemplateGroup> groups) {
        this.groups = groups;
    }
