...
@Api(value = "/productPicture", description = "产品调查图片Controller类")
public class TProductInvestPictureDescController extends BaseController<TProductInvestPictureDesc, Integer> {
