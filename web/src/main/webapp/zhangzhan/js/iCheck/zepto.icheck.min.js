...
{o:f,s:a.attr("style")}).css(d);f.inheritClass&&q[t](c.className||"");f.inheritID&&b&&q.attr("id",n+"-"+b);"zhangzhan"==q.css("position")&&q.css("position","relative");C(a,!0,E);if(k.length)k.on("click.i mouseover.i mouseout.i touchbegin.i touchend.i",function(b){var d=b[l],e=g(this);if(!c[u])if("click"==d?C(a,!1,!0):z&&(/ut|nd/.test(d)?(q[A](m),e[A](s)):(q[t](m),e[t](s))),G)b.stopPropagation();else return!1});a.on("click.i focus.i blur.i keyup.i keydown.i keypress.i",function(b){var d=b[l];b=b.keyCode;
