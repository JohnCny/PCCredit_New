...
<#macro content>
    ...
    <form class="content" href="/customerManager" method="post">
        <input type="hidden" id="userId" name="userId" value="${customerManager.userId}">
        <h1>管理</h1>
        ...
        <div class="report common">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" id="managerStatus" name="managerStatus" value="${customerManager.managerStatus}"></td>
                </tr>
            </table>
        </div>
        <p class="button">
            <input type="submit" id="btn_submit" value="保存" />
            <button type="button" class="back"><a href="/customerManager/index">返回</a></button>
        </p>
    </form>
...
<#macro script>
    <script>
        $(document).ready(function(){
            var url = "/customerManager";
            var Obj = {};
            var arr = ["userId","levelId","managerStatus"];
            ...
            $("#btn_submit").click(function (e) {
                ...
                $.ajax({
                    ...
                    success: function(res){
                        if(res.code == 200){
                            location.href="/customerManager/index";
                        }
                    },
                    error:function () {
                        alert("失败")
