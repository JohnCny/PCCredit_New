    ...
    <div class="col-xs-8" style="background-color: #ffffff; border-radius: 5px">
        ...
        <div class="report common">
               ...
               <!-- <tr>
                    ...
                    <td colspan="3"><input type="text" id="orgName" name="orgName" value="${tOrganization.orgName}"></td>
                </tr>
                <tr>
                    <td class="pull-right">负责人：</td>
                    <td><input type="text" id="orgDirectorName" name="orgDirectorName" value="${tOrganization.orgDirectorName}"></td>
                    <td class="pull-right">后勤：</td>
                    <td><input type="text" id="orgLogisticsId" name="orgLogisticsId" value="${tOrganization.orgLogisticsId}"></td>
                </tr>-->
            <ul class="rightRole">
                <li class="col-md-4 col-sm-12 col-xs-12">
                    <label>机构名称：</label>
                    <input type="text" id="orgName" name="orgName" value="${tOrganization.orgName}">
                </li>
                <li class="col-md-4 col-sm-12 col-xs-12">
                    <label>负责人：</label>
                    <input type="text" id="orgDirectorName" name="orgDirectorName" value="${tOrganization.orgDirectorName}">
                </li>
                <li class="col-md-4 col-sm-12 col-xs-12">
                    <label>后勤：</label>
                    <input type="text" id="orgLogisticsId" name="orgLogisticsId" value="${tOrganization.orgLogisticsId}">
                </li>
            </ul>
        </div>
        <p class="button">
